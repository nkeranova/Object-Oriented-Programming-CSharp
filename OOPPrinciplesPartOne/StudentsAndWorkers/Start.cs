...
namespace StudentsAndWorkers
{
    ...
    class Start
    {
        ...
        private static List<Worker> InitializeWorkers()
        {
            ...
            allWorkers.Add(new Worker("Sasho", "Draganov", 403, 8));
            allWorkers.Add(new Worker("Gesh", "Blagoev", 400, 8));
            allWorkers.Add(new Worker("Dani", "Docheva", 450, 6));
            allWorkers.Add(new Worker("Mario", "Petrov", 500, 12));
            allWorkers.Add(new Worker("Vasko", "Vaseev", 400, 6));
            allWorkers.Add(new Worker("Pesho", "Peichev", 500, 8));
            allWorkers.Add(new Worker("Ivan", "Petrov", 250, 6));
            allWorkers.Add(new Worker("Georgi", "Petrov", 200, 8));
            allWorkers.Add(new Worker("Reneta", "Georgieva", 600, 8));
            allWorkers.Add(new Worker("Gery", "Georova", 750, 6));
        ...
        private static List<Student> InitializeStudents()
        {
            ...
            allStudents.Add(new Student("Georgi", "Angelov", 12));
            allStudents.Add(new Student("Petra", "Lazova", 9));
            allStudents.Add(new Student("Ivan", "Vukov", 5));
            allStudents.Add(new Student("Stamen", "Ivanov", 9));
            allStudents.Add(new Student("Angel", "Moiseev", 8));
            allStudents.Add(new Student("Gele", "Penchev", 7));
            allStudents.Add(new Student("Hristo", "Hristov", 11));
            allStudents.Add(new Student("Krasi", "Krasimirov", 7));
